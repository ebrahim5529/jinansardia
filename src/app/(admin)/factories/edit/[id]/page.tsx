...
export default function EditFactoryPage() {
    ...
    // Mock existing factory data
    const [formData, setFormData] = useState({
        name: "مصنع الرياض للمستلزمات الطبية",
        tradeName: "Riyadh Medical Supplies Factory",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            console.log("Updated factory data:", formData);
        ...
        <div className="p-6 max-w-5xl mx-auto space-y-6">
            <div className="mb-8">
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    <span>/</span>
                    <span>تعديل مصنع</span>
                </div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                    تعديل المصنع #{factoryId}
                </h1>
                <p className="text-gray-600 dark:text-gray-400 mt-2">
                    تعديل معلومات المصنع
                </p>
            </div>
